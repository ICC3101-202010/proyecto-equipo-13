...
namespace ProyectoEquipo13
{
    public static class Console1
    {
        ...
        public static void SeeMovies(Computer computer, Premium userlogin)
        {
        ...
        public static void SeeMovies(Computer computer, Free userlogin)
        {
            Dictionary<int, Movies> dic = new Dictionary<int, Movies>();
            Console.WriteLine("\nSeleccione la película que desee:\n");
            int counter = 1;
        ...
        public static void SeeMoviesSearch(Computer computer, Premium userlogin, List<Movies> MOVIES)
        {
            Dictionary<int, Movies> dic = new Dictionary<int, Movies>();
            Console.WriteLine("\nSeleccione la película que desee:\n");
            int counter = 1;
        ...
        public static void SeeMoviesSearch(Computer computer, Free userlogin, List<Movies> MOVIES)
        {
            Dictionary<int, Movies> dic = new Dictionary<int, Movies>();
            Console.WriteLine("\nSeleccione la película que desee:\n");
            int counter = 1;
        ...
        public static void SeeSongsSearch(Computer computer, Premium userlogin, List<Songs> SONGS)
        {
            Dictionary<int, Songs> dic = new Dictionary<int, Songs>();
            Console.WriteLine("\nSeleccione la canción que desee:\n");
            int counter = 1;
        ...
        public static void SeeSongsSearch(Computer computer, Free userlogin, List<Songs> SONGS)
        {
            Dictionary<int, Songs> dic = new Dictionary<int, Songs>();
            Console.WriteLine("\nSeleccione la canción que desee:\n");
            int counter = 1;
        ...
        public static void CloseSesion(Computer computer, User user,MailSender mailSender)
        {
            //Volver al Log In 
