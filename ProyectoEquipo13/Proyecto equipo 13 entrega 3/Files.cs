    ...
    public static class Files
    {
        ...
        public static string AddUser(List<string> data)
        {
            ...
            { 
                ...
                if (data[4] == "PremiumT") { User premium = new User("Premium",data[0], data[1], data[2], true); Users.Add(premium); }
                else if (data[4] == "PremiumF") { User premium = new User("Premium",data[0], data[1], data[2], false); Users.Add(premium); }
                else if (data[4] == "Free") { User free = new User("Free",data[0], data[1], data[2]); Users.Add(free); }
            }
            return description;
        }
